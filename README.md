...
# Портфолио проектных материалов — Евгений Дзюбенко

PM / координатор реализации для технических, объектных, комплектационных, B2B и цифровизируемых проектов.
...
5. **InsurTech / страхование: C4 и REST API**   
...
6. **Media / стриминг-каталог: интеграции SOAP → REST**   
...
7. **MedTech / клиника: процессы и UI**  
...
8. **E-commerce / интернет-магазин: данные и SRS**    

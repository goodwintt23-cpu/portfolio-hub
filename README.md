...
Telegram: [`@zenalyse`](https://t.me/zenalyse) · Email: [`e.v.d@internet.ru`](e.v.d@internet.ru) · LinkedIn: [`Профиль`](www.linkedin.com/in/evgenii-dziubenko-sa) · Сетка: [`https://set.ki/nsEagMN`](https://set.ki/nsEagMN)
...
2. **PropTech · IoT / умный дом: MVP и прототип**  
...
3. **InsurTech / страхование: C4 и REST API**   
...
4. **Media / стриминг-каталог: интеграции SOAP → REST**   
...
5. **MedTech / клиника: процессы и UI**  
...
6. **E-commerce / интернет-магазин: данные и SRS**    
